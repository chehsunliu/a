...
fn calculate(
    ...
    for i in 0..points.len() {
        for j in i + 1..points.len() {
            ...
            let p3 = (p2.0 + diff.0, p2.1 + diff.1);
            let p4 = (p1.0 - diff.0, p1.1 - diff.1);

            if p3.0 >= 0 && p3.0 < boundary.0 && p3.1 >= 0 && p3.1 < boundary.1 {
                valid_points.insert(p3);
            }
            if p4.0 >= 0 && p4.0 < boundary.0 && p4.1 >= 0 && p4.1 < boundary.1 {
